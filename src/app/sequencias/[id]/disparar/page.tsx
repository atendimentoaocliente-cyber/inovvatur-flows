...
import { SequenceDispatchClient } from '@/components/SequenceDispatchClient';

export const dynamic = 'force-dynamic';

export default async function DispararSequenciaPage({
  params,
}: {
  ...
  return <SequenceDispatchClient sequence={data as Sequence} />;
}
